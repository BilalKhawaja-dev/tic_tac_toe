...
const config = {
  ...
  cognito: {
    ...
    enableGoogle: process.env.COGNITO_ENABLE_GOOGLE === 'true',
    enableFacebook: process.env.COGNITO_ENABLE_FACEBOOK === 'true',
    enableAmazon: process.env.COGNITO_ENABLE_AMAZON === 'true'
  }
};
